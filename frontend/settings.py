...
st.session_state.organization = st.text_input(
    "Organization",
...
st.session_state.country = st.selectbox(
    "Country",
    ["India", "USA", "UK", "Germany", "Australia"],
    index=["India", "USA", "UK", "Germany", "Australia"].index(st.session_state.country)
)
...
st.session_state.emission_alert = st.toggle(
    "Emission Spike Alerts",
    value=st.session_state.emission_alert
)

st.session_state.hotspot_alert = st.toggle(
    "Hotspot Alerts",
    value=st.session_state.hotspot_alert
)

st.session_state.ai_alert = st.toggle(
    "AI Sustainability Recommendations",
    value=st.session_state.ai_alert
)

st.session_state.weekly_report = st.toggle(
    "Weekly Sustainability Report",
    value=st.session_state.weekly_report
)
...
st.session_state.speech = st.toggle(
    "Enable Speech Recognition",
    value=st.session_state.speech
)
...
if st.button("Save Settings"):
    ...
    settings_data = dict(st.session_state)
