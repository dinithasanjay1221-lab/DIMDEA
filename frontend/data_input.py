...
def render():
    ...
    st.markdown(
        '<div class="hero-title">DIMDEA Data Input</div>',
        unsafe_allow_html=True
    )

    st.markdown(
        '<div class="hero-subtitle">Enter organization activity data to begin carbon analysis</div>',
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        '<div class="section-title">⚡ Scope 2 – Electricity Emissions</div>',
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        '<div class="section-title">🌎 Scope 3 – Indirect Emissions</div>',
        unsafe_allow_html=True
    )
    ...
    with col4:
        business_travel = st.number_input(
            "Business Travel Distance (km)",
            min_value=0.0,
            step=1.0
        )
